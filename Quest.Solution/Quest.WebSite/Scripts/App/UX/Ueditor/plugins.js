...
UE.plugins['formattribute'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormAttribute',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '设置表单属性',
                cssRules: "width:400px;height:310px;",
...
UE.plugins['formsaveas'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormSaveas',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '表单另存为',
...
UE.plugins['formcompile'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormCompile',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '发布表单',
                cssRules: "width:300px;height:120px;"
...
UE.plugins['formtextarea'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormTextarea',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '文本域',
                cssRules: "width:600px;height:300px;",
...
UE.plugins['formradio'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormRadio',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '单选按钮组',
...
UE.plugins['formcheckbox'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormCheckbox',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '复选按钮组',
                cssRules: "width:600px;height:360px;",
...
UE.plugins['formdatetime'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormDatetime',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '日期时间选择',
                cssRules: "width:600px;height:300px;",
...
UE.plugins['formhidden'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormHidden',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '隐藏域',
                cssRules: "width:500px;height:280px;",
...
UE.plugins['formselect'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormSelect',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '下拉列表框',
                cssRules: "width:600px;height:360px;",
...
UE.plugins['formfiles'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormFiles',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '附件上传',
                cssRules: "width:500px;height:280px;",
...
UE.plugins['formsubtable'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormSubtable',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '子表',
...
UE.plugins['formlabel'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormLabel',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: 'Label标签',
                cssRules: "width:600px;height:300px;",
...
UE.plugins['formbutton'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormButton',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '按钮',
                cssRules: "width:600px;height:300px;",
...
UE.plugins['formcombox'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormCombox',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '下拉组合框',
...
UE.plugins['formsumtext'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: '/SH_UEditor/FormSumtext',
                name: thePlugins + '_' + (new Date().valueOf()),
                editor: this,
                title: '计算字段',
                cssRules: "width:600px;height:300px;",
