...
Ext.define('Base.Role.Grid', {
    extend: 'Ext.user.NGrid',
    xtype: 'base_role_grid',
    stateId: 'base_role_grid',
    controllerName: 'Role',
    al: false,
    isSelect: false,
    layout: 'fit',
    //方法地址
    dataUrl: 'Role/GetAll',
    modelArray: ['Name', 'Desc', 'Id', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
    columns: [
        { text: '角色名', dataIndex: 'Name', flex: 1 },
    ...
    featureArray: [{
        ...
        text: '修改',
        serveUrl: 'Role/Update',
        iconCls: 'icon_edit',
        action: 'updata_Data',
        type: [1, 2]
    }, {
        text: '删除',
        serveUrl: 'Role/Delete',
        iconCls: 'icon_delete',
        action: 'del_Data',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        serveUrl: 'Role/Search',
        width: 300,
        action: 'search_Data',
        type: [1]
    }],
    ...
    add_Data: function (but, record, grid) {
        ...
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'Base.Role.Edit', hideFields: me.typeFields, config: {
