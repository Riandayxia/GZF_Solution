...
数据表
*/
Ext.define('Compiler.UDController.Grid', {
    extend: 'Ext.user.NGrid',
    xtype: 'compiler_udcontroller_grid',
    stateId: 'compiler_udcontroller_grid',
    controllerName: 'UDController',
    al: true,
    isSelect: false,
    layout: 'fit',
    //方法地址
    dataUrl: 'UDController/GetAll',
    ...
    featureArray: [{
        ...
        text: '删除',
        serveUrl: 'UDController/Del',
        iconCls: 'icon_delete',
        action: 'del_Data',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        serveUrl: 'UDController/Search',
        width: 300,
        action: 'search_Data',
        type: [1]
    }],
    ...
    add_Data: function (but, record, grid) {
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'Compiler.UDController.Auto.Edit', hideFields: me.typeFields, config: {
