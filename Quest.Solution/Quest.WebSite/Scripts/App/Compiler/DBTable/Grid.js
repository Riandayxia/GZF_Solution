...
数据表
*/
Ext.define('Compiler.DBTable.Grid', {
    extend: 'Ext.user.NGrid',
    xtype: 'compiler_dbtable_grid',
    stateId: 'compiler_dbtable_grid',
    controllerName: 'DBTable',
    al: true,
    isSelect: false,
    layout: 'fit',
    //方法地址
    dataUrl: 'DBTable/GetAll',
    ...
    featureArray: [{
        ...
        text: '动态编译',
        serveUrl: 'DBTable/Auto',
        iconCls: 'icon_bullseye',
        action: 'auto_Data',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        serveUrl: 'DBTable/Search',
        width: 300,
        action: 'search_Data',
        type: [1]
    }],
    ...
    add_Data: function (but, record, grid) {
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'Compiler.DBTable.Edit', hideFields: grid.typeFields, config: {
    ...
    updata_Data: function (but, record) {
        ...
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'Compiler.DBTable.Edit', hideFields: me.typeFields, config: {
                saveUrl: but.menuObj.serveUrl,
