...
Ext.define('BPM.CDColumn.Grid', {
    ...
    modelArray: ['Id', 'CreatedTime', 'LastUpdatedTime', 'Name', 'TableId', 'Creator', 'Text', 'DBType', 'Desc', 'Sort'],
    columns: [
        ...
        { text: '文本', dataIndex: 'Text', flex: 1, minWidth: 0 },
        { text: '类型', dataIndex: 'DBType', flex: 1, minWidth: 0 },
