...
Ext.define('BPM.CDColumn.Edit', {
    ...
    items: [
        ...
        { fieldLabel: '名称', name: 'Name', xtype: 'textfield', allowBlank: true, value: 'zd1' },
        { fieldLabel: '文本', name: 'Text', xtype: 'textfield', allowBlank: false, value: '字段' },
        { fieldLabel: '类型', name: 'DBType', xtype: 'combobox', allowBlank: false, valueField: 'Value', displayField: 'Name', value: 'varchar' },
        { fieldLabel: '序号', name: 'Sort', xtype: 'numberfield', allowBlank: false, value: 1 },
        { fieldLabel: '创建者', name: 'Creator', xtype: 'textfield', allowBlank: false, value: 1 },
