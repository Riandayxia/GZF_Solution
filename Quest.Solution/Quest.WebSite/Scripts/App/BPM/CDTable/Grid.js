...
Ext.define('BPM.CDTable.Grid', {
    ...
    xtype: 'bpm_cdtable_grid',
    stateId: 'bpm_cdtable_grid',
    controllerName: 'CDTable',
    al: false,
    isSelect: false,
    layout: 'fit',
    //方法地址
    dataUrl: 'CDTable/GetAll',
    modelArray: ['Name', 'ByName', 'Desc', 'Sort', 'Creator', 'Id', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
    columns: [
        { text: '数据库表名', dataIndex: 'Name', flex: 1 },
		{ text: '别名', dataIndex: 'ByName', flex: 1 },
