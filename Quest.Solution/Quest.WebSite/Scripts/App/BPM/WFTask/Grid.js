...
Ext.define('BPM.WFTask.Grid', {
    ...
    columns: [
        { text: '上一任务Id', dataIndex: 'ParentId', flex: 1, hidden: true },
		{ text: '实体Id', dataIndex: 'InstanceId', flex: 1, hidden: true },
		{ text: '主体id', dataIndex: 'MainId', flex: 1, hidden: true },
		{ text: '步骤Id', dataIndex: 'StepId', flex: 1, hidden: true },
		{ text: '表单Id', dataIndex: 'FormId', flex: 1, hidden: true },
		{ text: '步骤名称', dataIndex: 'StepName', flex: 1 },
		{ text: '任务类型', dataIndex: 'Type', flex: 1, hidden: true },
		...
		{ text: '意见', dataIndex: 'Comment', flex: 1, hidden: true },
		{ text: '是否签章', dataIndex: 'IsSign', flex: 1, hidden: true },
		{ text: '状态', dataIndex: 'Status', flex: 1 },
		{ text: '其它说明', dataIndex: 'Note', flex: 1, hidden: true },
		{ text: '序号', dataIndex: 'Sort', flex: 1, hidden: true },
