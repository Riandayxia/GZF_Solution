...
namespace Quest.WebSite.Controllers.Base
{
    ...
    public partial class MenuController : BaseController
    {
        ...
        /// 添加 菜单数据
        /// </summary>
        /// <param name="entity">菜单对象</param>
        /// <returns>返回操作结果</returns>
        [HttpPost]
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(Menu entity)
        {
            OperationResult or = MenuService.Insert(entity);
        ...
        public virtual ActionResult Update(Menu entity)
        {
            entity.LastUpdatedTime = DateTime.Now;
            OperationResult or = MenuService.Update(entity);
            return this.JsonFormat(or);
        }

        /// <summary>
        /// 删除 菜单数据 
        /// 根据菜单唯一标识Id集合,数据格式','隔开“1,2,3,4...”
        /// </summary>
        /// <returns>返回操作结果</returns>
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = MenuService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
