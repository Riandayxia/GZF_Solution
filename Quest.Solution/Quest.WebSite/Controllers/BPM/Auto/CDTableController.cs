...
namespace Quest.WebSite.Controllers.BPM
{
    ...
    public partial class CDTableController : BaseController
    {
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(CDTable entity)
        {
            OperationResult or = CDTableService.Insert(entity);
        ...
        public virtual ActionResult Update(CDTable entity)
        {
            entity.LastUpdatedTime = DateTime.Now;
            OperationResult or = CDTableService.Update(entity);
            return this.JsonFormat(or);
        }
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = CDTableService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
