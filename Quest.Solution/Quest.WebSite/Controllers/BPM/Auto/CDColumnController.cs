...
namespace Quest.WebSite.Controllers.BPM
{
    ...
    public partial class CDColumnController : BaseController
    {
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(CDColumn entity)
        {
            OperationResult or = CDColumnService.Insert(entity);
        ...
        public virtual ActionResult Update(CDColumn entity)
        {
            entity.LastUpdatedTime = DateTime.Now;
            OperationResult or = CDColumnService.Update(entity);
            return this.JsonFormat(or);
        }
