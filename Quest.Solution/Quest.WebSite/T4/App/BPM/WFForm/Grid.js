/**-----------------------------------------------------------------
* @explanation:表单管理信息列表
* @created：rainday
* @create time：2016-09-22 09:17
* @modified history: //修改历史
/-------------------------------------------------------------------*/

Ext.define('BPM.WFForm.Grid', {
    extend: 'Ext.user.NGrid',
    xtype: 'bpm_wfform_grid',
    stateId: 'bpm_wfform_grid',
    ...
    modelArray: ['Title', 'DBTable', 'DBTableName', 'Url_AddOrUpdate', 'TitleField', 'RunHtml', 'DesignHtml', 'Id', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
    columns: [
        { text: '表单名称', dataIndex: 'Title', flex: 1 },
		{ text: '数据表', dataIndex: 'DBTable', flex: 1 },
		{ text: '数据表名称', dataIndex: 'DBTableName', flex: 1 },
		{ text: '处理地址', dataIndex: 'Url_AddOrUpdate', flex: 1 },
		{ text: '标题字段', dataIndex: 'TitleField', flex: 1 },
		{ text: '运行html', dataIndex: 'RunHtml', flex: 1 },
		{ text: '设计html', dataIndex: 'DesignHtml', flex: 1 },
    ...
    featureArray: [{
        ...
        iconCls: 'icon_edit',
        text: '修改',
        serveUrl: 'WFForm/Update',
        type: [1, 2]
    }, {
        action: 'del_Data',
        iconCls: 'icon_delete',
        text: '删除',
        serveUrl: 'WFForm/Delete',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        action: 'search_Data',
        serveUrl: 'WFForm/Search',
        width: 300,
        type: [1]
    }],
    // 事件监听器
    ...
    add_Data: function (but, record, grid) {
        ...
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'BPM.WFForm.Edit', hideFields: me.typeFields, config: {
