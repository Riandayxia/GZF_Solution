...
Ext.define('BPM.CDColumn.Grid', {
    extend: 'Ext.user.NGrid',
    xtype: 'bpm_cdcolumn_grid',
    stateId: 'bpm_cdcolumn_grid',
    controllerName: 'CDColumn',
    al: false,
    isSelect: false,
    layout: 'fit',
    //方法地址
    dataUrl: 'CDColumn/GetAll',
    modelArray: ['TableId', 'Name', 'Text', 'DBType', 'Creator', 'Sort', 'IsNull', 'Desc', 'Id', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
    columns: [
        { text: '对应表', dataIndex: 'TableId', flex: 1 },
		{ text: '名称', dataIndex: 'Name', flex: 1 },
		{ text: '文本', dataIndex: 'Text', flex: 1 },
		{ text: '类型', dataIndex: 'DBType', flex: 1 },
		{ text: '创建者', dataIndex: 'Creator', flex: 1 },
		{ text: '排序', dataIndex: 'Sort', flex: 1 },
		{ text: '是否为空', dataIndex: 'IsNull', flex: 1 },
    ...
    featureArray: [{
        ...
        iconCls: 'icon_add',
        text: '新增',
        serveUrl: 'CDColumn/Add',
        type: [1, 3]
    }, {
        action: 'updata_Data',
        iconCls: 'icon_edit',
        text: '修改',
        serveUrl: 'CDColumn/Update',
        type: [1, 2]
    }, {
        action: 'del_Data',
        iconCls: 'icon_delete',
        text: '删除',
        serveUrl: 'CDColumn/Delete',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        action: 'search_Data',
        serveUrl: 'CDColumn/Search',
        width: 300,
        type: [1]
    }],
    // 事件监听器
