...
Ext.define('BPM.CDList.Grid', {
    ...
    columns: [
        { text: '数据库表Id', dataIndex: 'DBTableId', flex: 1 },
		{ text: '数据库表', dataIndex: 'DBTableName', flex: 1 },
		{ text: '创建者', dataIndex: 'Creator', flex: 1 },
		{ text: 'DesignJson', dataIndex: 'DesignJson', flex: 1 },
		{ text: 'RunJson', dataIndex: 'RunJson', flex: 1 },
    ...
    featureArray: [{
        ...
        iconCls: 'icon_edit',
        text: '修改',
        serveUrl: 'CDList/Update',
        type: [1, 2]
    }, {
        action: 'del_Data',
        iconCls: 'icon_delete',
        text: '删除',
        serveUrl: 'CDList/Delete',
        type: [1, 2]
    }, {
        otype: 'nsearch',
        action: 'search_Data',
        serveUrl: 'CDList/Search',
        width: 300,
        type: [1]
    }],
    // 事件监听器
    ...
    add_Data: function (but, record, grid) {
        ...
        //获得 添加窗体对象
        var object = {
            winTitle: but.text, winWidth: 660, win: 'BPM.CDList.Edit', hideFields: me.typeFields, config: {
