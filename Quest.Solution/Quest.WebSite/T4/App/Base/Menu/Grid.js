...
Ext.define('Base.Menu.Grid', {
    ...
    //方法地址
    dataUrl: 'Menu/GetAll',
    modelArray: ['Name', 'ParentName', 'ControllerName', 'FeatureName', 'MenuLink', 'PhoneLink', 'Params', 'IconClass', 'MType', 'Use', 'Id', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
    columns: [
        { text: '菜单名称', dataIndex: 'Name', flex: 1 },
		{ text: '上级菜单名称', dataIndex: 'ParentName', flex: 1 },
		{ text: '控制器名称', dataIndex: 'ControllerName', flex: 1 },
		{ text: '功能名称', dataIndex: 'FeatureName', flex: 1 },
		{ text: '菜单链接', dataIndex: 'MenuLink', flex: 1 },
		{ text: '手机地址', dataIndex: 'PhoneLink', flex: 1 },
		{ text: '参数', dataIndex: 'Params', flex: 1 },
