...
/-------------------------------------------------------------------*/
Ext.define('QST.HouseManage.Housekeeping.PAEdit', {
    extend: 'app.user.NForm',
    xtype: 'houseManage_housekeeping_paedit',
    config: {
        title: config.str.Parenting,
        defaults: {
            labelWidth: '20%'
        },
        items: [{
            ...
            items: [
                ...
                { label: '服务类型', name: 'Type', xtype: 'hiddenfield', value: "10002005" },
