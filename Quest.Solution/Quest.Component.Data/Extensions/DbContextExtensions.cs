...
namespace SuHui.Component.Data.Extensions
{
    public static class DbContextExtensions
    {
        public static void Update<TEntity, TKey>(this DbContext dbContext, params TEntity[] entities) where TEntity : BaseEntity<TKey>
        {
