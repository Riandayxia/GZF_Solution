...
using SuHui.Component.Data.Extensions;
...
namespace SuHui.Component.Data
{
    ...
    public abstract class UnitOfWorkContextBase : IUnitOfWorkContext
    {
        ...
        public void RegisterNew<TEntity, TKey>(TEntity entity) where TEntity : BaseEntity<TKey>
        {
        ...
        public void RegisterNew<TEntity, TKey>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<TKey>
        {
            try
            {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entity"> 要注册的对象 </param>
        public void RegisterModified<TEntity, TKey>(TEntity entity) where TEntity : BaseEntity<TKey>
        {
        ...
        public void RegisterModified<TEntity, TKey>(Expression<Func<TEntity, object>> propertyExpression, TEntity entity) where TEntity : BaseEntity<TKey>
        {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entity"> 要注册的对象 </param>
        public void RegisterDeleted<TEntity, TKey>(TEntity entity) where TEntity : BaseEntity<TKey>
        {
        ...
        /// <typeparam name="TKey">实体主键类型</typeparam>
        /// <param name="entities"> 要注册的对象集合 </param>
        public void RegisterDeleted<TEntity, TKey>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<TKey>
        {
            try
            {
                Context.Configuration.AutoDetectChangesEnabled = false;
