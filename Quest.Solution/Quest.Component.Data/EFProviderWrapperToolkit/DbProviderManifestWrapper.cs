...
namespace EFProviderWrapperToolkit
{
    ...
    public class DbProviderManifestWrapper : DbProviderManifest
    {
        ...
        /// </summary>
        /// <param name="storeType">The instance of the <see cref="T:TypeUsage"/> class that encapsulates both a storage type and a set of facets for that type.</param>
        /// <returns>
        /// The instance of that <see cref="T:TypeUsage"/> encapsulates both an EDM type and a set of facets for that type.
        /// </returns>
        ...
        /// </summary>
        /// <param name="edmType">The instance of the <see cref="T:TypeUsage"/> class that encapsulates both an EDM type and a set of facets for that type.</param>
        /// <returns>
        /// The instance of the <see cref="T:TypeUsage"/> class that encapsulates both a storage type and a set of facets for that type.
        /// </returns>
